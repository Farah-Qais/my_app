...
class Cars1sControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cars1" do
    assert_difference("Cars1.count") do
      post cars1s_url, params: { cars1: { type: @cars1.type, user_id: @cars1.user_id, vin: @cars1.vin } }
    end
  ...
  test "should update cars1" do
    patch cars1_url(@cars1), params: { cars1: { type: @cars1.type, user_id: @cars1.user_id, vin: @cars1.vin } }
